...
void PlikZAdresatami::usunWybranegoAdresataZPliku(int idUsuwanegoAdresata)
{
    ...
    if (odczytywanyPlikTekstowy.good() == true )
    {
        while (getline(odczytywanyPlikTekstowy, wczytanaLinia))
        {
            ...
            if (numerWczytanejLinii == 1 && idUsuwanegoAdresata == pobierzIdAdresataZDanychOddzielonychPionowymiKreskami(wczytanaLinia))
            ...
            else if (numerWczytanejLinii == 2 && numerUsuwanejLinii == 1 && idUsuwanegoAdresata != pobierzIdAdresataZDanychOddzielonychPionowymiKreskami(wczytanaLinia))
                tymczasowyPlikTekstowy << wczytanaLinia;
            else if (numerWczytanejLinii > 2 && numerUsuwanejLinii == 1 && idUsuwanegoAdresata != pobierzIdAdresataZDanychOddzielonychPionowymiKreskami(wczytanaLinia))
...
void PlikZAdresatami::zaktualizujDaneWybranegoAdresata(Adresat adresat)
{
    ...
    liniaZDanymiAdresata = zamienDaneAdresataNaLinieZDanymiOddzielonymiPionowymiKreskami(adresat);
    edytujWybranaLinieWPliku(idAdresata, liniaZDanymiAdresata);
